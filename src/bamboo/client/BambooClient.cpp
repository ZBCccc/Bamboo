...
int BambooClient::DataUpdate(std::string &L, std::string &D, std::string &C,
                             BambooOp op, const std::string &keyword,
                             const std::string &id) {
  StateCell cell;
...
int BambooClient::Trapdoor(std::string &K_out, std::string &L,
                           std::string &MskD, std::string &MskC,
...
int BambooClient::DecryptResult(std::vector<std::string> &plain_out,
...
void BambooClient::BatchDataUpdate(
    vector<std::string> &Ls, vector<std::string> &Ds, vector<std::string> &Cs,
