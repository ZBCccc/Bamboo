...
public:
  ...
  void SaveBatch(const std::vector<std::string> &Ls,
                 const std::vector<std::string> &Ds,
                 const std::vector<std::string> &Cs);

  void Search(std::vector<std::string> &result, const std::string &K_in,
              const std::string &L_in, const std::string &MskD_in,
